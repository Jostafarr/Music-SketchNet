...
def process_irish(s_dir, dataset_path):
    if os.path.exists("data/irish_train.npy") and os.path.exists("data/irish_validate.npy") and os.path.exists("data/irish_test.npy"):
        print("irish already processed")
        return 
